...
|Delay pasting [ms]|`320`|Maybe you have got a slow PC? This setting will help to set correct time value before minimizing the Hamster and pasting text to destination window. \nOn my very old laptop from 2007, _delay pasting_ set to `200` ms was too fast|
|**Text items**|||
