...
You can mask passwords with stars ****** but remember if you chose _'Save list to a file'_ in _'Preferences'_ window your password will be saved as __plain text__ in ~/.config/hamster/item.json file
